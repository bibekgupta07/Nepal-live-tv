...
val OverlayBlack = Color(0xB3000000)
val MediumOverlayBlack = Color(0x80000000)
val LightOverlayBlack = Color(0x66000000)

// Settings UI Colors
val IconBoxMoonBg = Color(0xFF2C191D)
val IconBoxLanguageBg = Color(0xFF262730)
val IconBoxCastBg = Color(0xFF131F37)
val IconBoxForceHdBg = Color(0xFF211936)
val IconBoxQualityBg = Color(0xFF2A2213)
val IconBoxNotifBg = Color(0xFF2C1E14)

val PremiumBoxBg = Color(0xFF2B1315)
val PremiumBoxBorder = Color(0xFF662226)
...
val M2GradientStart = Color(0xFFFF6B35)
val M2GradientEnd = Color(0xFFFF9500)
val KBlueBg = Color(0xFF2A64F6)
val AP1PurpleBg = Color(0xFF7838D5)
val NTVGreenBg = Color(0xFF138A5A)